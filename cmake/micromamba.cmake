function(mamba_get_url MAMBA_URL)
    if (CMAKE_HOST_APPLE)
        if (${CMAKE_HOST_SYSTEM_PROCESSOR} MATCHES "arm")
            set(MAMBA_URL "https://micro.mamba.pm/api/micromamba/osx-arm64/latest")
        else ()
            set(MAMBA_URL "https://micro.mamba.pm/api/micromamba/osx-64/latest")
        endif ()
    elseif (LINUX)
        if (${CMAKE_HOST_SYSTEM_PROCESSOR} MATCHES "x64|x86_64")
            set(MAMBA_URL "https://micro.mamba.pm/api/micromamba/linux-64/latest")
        elseif (${CMAKE_HOST_SYSTEM_PROCESSOR} MATCHES "aarch64|arm64")
            set(MAMBA_URL "https://micro.mamba.pm/api/micromamba/linux-aarch64/latest")
        endif ()
