...
TESTS = [
    ...
    NosTest("disorder_THPP", _dir="disorder", _good="disorder_THPP.good",
            cif="thpp.cif", hkl="thpp.hkl", acc=0, no_date=True,
    ...
    NosTest("grown_water", _dir="grown", cif="water.cif", hkl="water.hkl", wfn="water.wfx", acc=0, no_date=True),
    NosTest("Hybrid_mode", _dir="Hybrid", cif="ZP2.cif", dmin=0.9, acc=0, no_date=True,
            mtc=["ZP2_part1.gbw", 0.1, "ZP2_part2.gbw", 0.2], mtc_mult=[1, 1], mtc_charge=[0, 0], mtc_ECP=[0, 0]),
    NosTest("malbac_SF_ECP", _dir="ECP_SF", cif="malbac.cif", hkl="malbac.hkl", wfn="malbac.gbw", acc=0, ECP=1, no_date=True),
    ...
    NosTest("rubredoxin_cmtc", _dir="rubredoxin_cmtc", hkl="1yk4_h.hkl", acc=0, no_date=True,
    ...
    NosTest("sucrose_ptb", _dir="sucrose_IAM_SF", cif="sucrose.cif", dmin=0.8, wfn="wfn.xtb", mult=0, charge=0, acc=0, ECP=3, no_date=True),
    NosTest("sucrose_SF", _dir="sucrose_fchk_SF", cif="sucrose.cif", hkl="olex2/Wfn_job/sucrose.hkl", wfn="olex2/Wfn_job/sucrose.wfx", acc=0, no_date=True),
    NosTest("sucrose_twin", _dir="sucrose_fchk_SF", cif="sucrose.cif", hkl="olex2/Wfn_job/sucrose.hkl", wfn="olex2/Wfn_job/sucrose.wfx", acc=0, twin=[1, 0, 0, 0, -1, 0, 0, 1, -2], no_date=True),
    NosTest("wfn_reading", _dir="wfn_reading", hkl="test.hkl", acc=0, cif="test.cif", wfn="test.wfn", no_date=True),
