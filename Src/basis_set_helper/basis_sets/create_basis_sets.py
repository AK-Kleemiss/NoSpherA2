...
def get_Basis_Nospera2(basis):
    out = ""
    elements = [int(x) for x in basis["elements"].keys()]
    last_element = 118
    for element in range(1, last_element + 1):
        out +=  f"{numberToSymbol[element]}\n"
