...
*/
{
    ...
    n = gen_oh(1, a, b, v, x, y, z, w);
    v = 0.5716905949977102e-2;
    n += gen_oh(2, a, b, v, x + n, y + n, z + n, w + n);
    v = 0.5573383178848738e-2;
    n += gen_oh(3, a, b, v, x + n, y + n, z + n, w + n);
    a = 0.6712973442695226;
    v = 0.5608704082587997e-2;
    n += gen_oh(4, a, b, v, x + n, y + n, z + n, w + n);
    ...
    n += gen_oh(5, a, b, v, x + n, y + n, z + n, w + n);
