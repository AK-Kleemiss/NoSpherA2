						  ...
						  time_point end1)
{
	...
	if (dur < 1)
		file << "Total Time: " << fixed << setprecision(0) << get_msec(start, end) << " µs\n";
	else if (dur < 60)
