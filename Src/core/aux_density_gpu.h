...
//
//The device runs aux_density::at from aux_density.h, the same inline text the CPU loop
//in calc_density_ML runs, on the flattened basis it is handed. Small point sets stay on
//the host, the launch and the copies cost more than the work there.
//
